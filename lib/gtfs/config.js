...
const configuredRealtimeExpirationSeconds = Number.parseInt(
  environment.GTFS_RT_EXPIRATION_SECONDS,
  10,
);
const gtfsRealtimeExpirationSeconds =
  Number.isInteger(configuredRealtimeExpirationSeconds) &&
  configuredRealtimeExpirationSeconds > 0
    ? configuredRealtimeExpirationSeconds
    : 180;
